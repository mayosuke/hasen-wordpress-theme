...
<?php
// TODO: Add capability for changing the value of 'posts_per_page'
$args = array( 'post_type' => 'post', 'orderby' => 'date', 'order' => 'DESC', 'posts_per_page' => 3);
$query = new WP_query($args);
if ($query->have_posts()) :
?>
  ...
  <div class="latest-posts-list">
    <?php while ($query->have_posts()) : $query->the_post();
      get_template_part( 'content-text-only' );
    endwhile;
    wp_reset_postdata(); ?>
    <div class="clear"></div>
  </div> <!-- /posts -->
